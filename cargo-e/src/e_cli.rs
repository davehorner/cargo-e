...
pub struct Cli {
    ...
    #[arg(long, value_name = "PATH", help = "Path to read/write the stdout of the executed command.")]
    pub stdout: Option<std::path::PathBuf>,

    /// Path to read/write the stderr of the executed command.
    #[arg(long, value_name = "PATH", help = "Path to read/write the stderr of the executed command.")]
