...
impl PositionGrid {
    ...
    #[cfg(target_os = "windows")]
    pub fn get_grid_hwnd(&self) -> Option<HWND> {
        self.host_hwnd
    }
    ...
    pub fn new_with_rect(host_hwnd: Option<HWND>, rect: Rect, char_size: egui::Vec2, grid_size: egui::Vec2, color: Color32) -> Self {
        let grid_dims = (
    ...
    pub fn from_text_style(host_hwnd: Option<u32>, ui: &Ui, style: egui::TextStyle, color: Color32, grid_dims: Option<(usize, usize)>) -> (Self, egui::Vec2) {
        ...
        (
            Self {
                ...
                fill: None,
                #[cfg(target_os = "windows")]
                host_hwnd: host_hwnd.map(|hwnd| hwnd as HWND),
            },
            char_size,
        )
    }
